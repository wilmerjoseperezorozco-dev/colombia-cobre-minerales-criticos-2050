...
6. La cifra de inversión de El Roble en la Tabla 28 de UPME (USD 9.475 millones) es inconsistente con su escala real de producción (~27.000 t/año de cobre contenido) frente a Quebradona y Soto Norte. **Verificación (21-sep-2026):** se confirmó que la transcripción es exacta (contra la página 87 del PDF fuente) y que el valor es internamente consistente con el resto de la misma tabla (26.843 t × USD 3.700/t de costo C1 = USD 99.319.100, coincide con la fila de costos); no se encontró una cifra corregida en los otros 2 informes de UPME sobre cobre disponibles en este repositorio. La hipótesis más plausible —que la cifra representa valor económico acumulado durante la vida operativa de la mina, no un capex comparable— es razonamiento propio, no una confirmación oficial; se reporta tal cual aparece en la fuente, sin corregirla unilateralmente (ver detalle completo en `data/upme_informe_cobre_hallazgos_curados.json`).
