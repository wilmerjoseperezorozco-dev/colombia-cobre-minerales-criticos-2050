...
| Empresa | Proyecto en Colombia | Bolsa / ticker (verificar antes de operar) | Naturaleza de la exposición |
|---|---|---|---|
| **AngloGold Ashanti plc** | Quebradona (Antioquia) | NYSE: AU | Compañía grande, diversificada (oro principalmente); Quebradona es un proyecto entre varios — exposición diluida y actualmente frenado por incertidumbre regulatoria |
| **Atico Mining Corporation** | El Roble (Chocó) — única mina de cobre en producción del país | TSXV: ATY · OTC: ATCMF | Small-cap, exposición concentrada; mayor volatilidad y menor liquidez |
| **Aris Mining Corporation** | Soto Norte (Santander) | NYSE: ARIS (antes ARMN) · TSX: ARIS | Proyecto detenido por falta de licencia ambiental — la tesis de inversión depende de que se resuelva ese trámite |
| **GoldMining Inc.** | Titiribí (Antioquia) | Verificar ticker vigente en TSX/NYSE American antes de operar | Proyecto en etapa temprana de exploración conjunta oro-cobre |
| **JCHX Mining Management Co.** | El Alacrán (Córdoba) — proyecto de cobre más avanzado del país | Bolsa de Shanghái: 603979.SS | Es la contraparte china que controla el proyecto más avanzado; exposición indirecta a Colombia dentro de un portafolio minero chino más amplio — relevante como referencia geopolítica, no como vehículo natural para un inversionista colombiano o estadounidense alineado con el marco de Barranquilla |

## 2. Cómo leer esta tabla con criterio, no solo como lista de tickers

- **Ninguna de estas empresas es "pura" en cobre colombiano** — todas tienen otros activos (oro, otros países) que diluyen la exposición real al tema de este informe.
...
- Resultado del pulso institucional descrito en `06-soluciones-juridicas-e-institucionales.md` (¿desregulación sostenida o nuevo giro hacia control estatal?).
- Resolución de la situación de Quebradona (Resolución 855/2025).
- Si El Alacrán logra cerrar su ronda de capital (~USD 470 M buscados para la siguiente etapa) y con qué inversionistas — sería la señal más clara de si el marco EE.UU.–Colombia empieza a diversificar el capital del sector o no.
