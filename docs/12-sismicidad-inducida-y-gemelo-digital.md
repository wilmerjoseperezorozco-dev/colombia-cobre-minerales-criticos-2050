...
**Matiz científico importante (25-sep-2026), para no sobregeneralizar:** no todo colapso de infraestructura minera de esta magnitud tiene la sismicidad inducida como causa principal. Fardin (2026, *Soil Dynamics and Earthquake Engineering*, [10.1016/j.soildyn.2026.110214](https://doi.org/10.1016/j.soildyn.2026.110214)) analizó dinámicamente el otro gran desastre de relaves de la región — Fundão, Brasil, noviembre de 2015 — y encontró que la secuencia sísmica de baja magnitud que precedió la falla tuvo una contribución **limitada**: actuó como disparador secundario que aceleró un proceso de licuefacción ya en marcha por causas estáticas (geotécnicas), no como la causa dominante. Es la diferencia real entre los dos casos que este documento cita como referencia: en **El Teniente, la sismicidad inducida fue el evento gatillante directo**; en **Fundão, fue un acelerador secundario de un problema geotécnico de fondo**. La implicación práctica es que un sistema de monitoreo centrado solo en sismicidad (el foco de este documento) no habría sido suficiente para anticipar Fundão — se necesita, además, el monitoreo geotécnico convencional (línea freática, presión de poros) que ya se documenta en `docs/02-ia-medicion-y-formulas.md`, sección 3.
