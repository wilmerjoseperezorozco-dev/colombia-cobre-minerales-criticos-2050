...
## 12. Colombia es el 6º productor mundial de platino — y este repositorio, dedicado a minerales críticos, nunca lo había mencionado

Buscando literatura sobre el cinturón cuprífero andino (issue #18), apareció un hallazgo completamente distinto: Colombia lleva **469 años consecutivos** de producción de platino en el Chocó (primer reporte en 1557, durante el Imperio español) y sigue siendo, hoy, el sexto productor mundial — 28.359 onzas en 2011, principalmente por minería artesanal a pequeña escala en el río San Juan. El Complejo Máfico-Ultramáfico de Condoto, con concesiones sobre 140 km², es el mejor candidato identificado a fuente de roca dura de ese platino aluvial. Es un mineral crítico real, con producción real, en un departamento que este repositorio ya cubre extensamente por el cobre de El Roble — y hasta ahora nunca había aparecido. *(Haldar, S.K. 2017, "Deposits of South America", en *Platinum-Nickel-Chromium Deposits*, Elsevier, [10.1016/B978-0-12-802041-8.00005-5](https://doi.org/10.1016/B978-0-12-802041-8.00005-5))*
