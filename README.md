...
| [`docs/14-hallazgos-curiosos.md`](docs/14-hallazgos-curiosos.md) | Datos sorprendentes o contraintuitivos ya encontrados en la investigación — documento vivo, se amplía fase a fase |
| [`docs/15-auditoria-rigor-evidencial.md`](docs/15-auditoria-rigor-evidencial.md) | Auditoría crítica sin sesgo: qué está sólidamente fundamentado, dónde se depende demasiado de prensa, y qué literatura académica falta por tema |
| [`docs/16-especificacion-tecnica-monitoreo-relaves.md`](docs/16-especificacion-tecnica-monitoreo-relaves.md) | Especificación técnica exigible por contrato para monitoreo de relaves, con umbrales y arquitecturas de la literatura académica (no recomendaciones genéricas) |
| [`docs/17-diseno-piloto-prospectividad-ia.md`](docs/17-diseno-piloto-prospectividad-ia.md) | Plan ejecutable en 4 fases para el piloto de prospectividad con IA (issue #9), basado en un método publicado con 0,96 de exactitud |
| [`docs/18-analisis-integrado-tres-objetivos.md`](docs/18-analisis-integrado-tres-objetivos.md) | Justificación, marco teórico y análisis de 3 objetivos (geocronología, plata en calcopirita, benchmarking metalúrgico) comparando Colombia con Chile y Perú, con propuesta de protocolo innovador |
